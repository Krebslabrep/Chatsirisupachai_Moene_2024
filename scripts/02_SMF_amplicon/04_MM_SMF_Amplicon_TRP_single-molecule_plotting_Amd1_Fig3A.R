########## Plot single-molecule of the TRP analysis (For representative promoter NM_009665.5) ##########
...
Avg_pl + geom_vline(xintercept = 0,
                    linetype = "dashed", 
                    color = "#737373") +
  ggtitle("Amd1 (chr10:40301989-40302388)") -> Avg_pl
...
#pdf("/g/krebs/chatsiri/mouse_droso_PolII/re_analysis/analysis/SMF/MM_analysis/TRP_analysis/Amd1_example_simpler_quantification_plot.pdf", 
