...
SMF <- readRDS("/g/krebs/chatsiri/mouse_droso_PolII/Chatsirisupachai_Moene_2024/data/MM/amplicon_SMF/MM_TKO_DE_amplicon_TRP_promoter_states_freq_matrix.rds")
SMF$DMSO_DE_ %>% data.frame() %>% rownames_to_column() -> SMF
...
#pdf("/g/krebs/chatsiri/mouse_droso_PolII/re_analysis/analysis/SMF/MM_analysis/corr_plot/corr_SMF_Amplicon_RNA_ChIP_MNase_PRO.pdf",
