...
* Calculate mouse promoter ChIP-seq signal from Langer et al., 2016, this is used to define top 5% promoters by Pol II ChIP-seq signal.
...
* Calculate _Drosophila_ promoter ChIP-seq signal from Tettey et al., 2019, this is used to define top 5% promoters by Pol II ChIP-seq signal.
