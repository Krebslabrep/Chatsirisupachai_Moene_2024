...
Qinput <- "/g/krebs/chatsiri/mouse_droso_PolII/Chatsirisupachai_Moene_2024/data/Qinput_files/Qinput_whole-genome_SMF_DM_OSC.txt"
...
# saveRDS(ContextMeth_all, "/g/krebs/chatsiri/mouse_droso_PolII/Chatsirisupachai_Moene_2024/data/DM/DM_context_methylation_OSC.rds")
...
saveRDS(ContextMeth_subset, "/g/krebs/chatsiri/mouse_droso_PolII/Chatsirisupachai_Moene_2024/data/DM/DM_context_methylation_OSC.rds")
